...
?>
        ...
        <nav id="menu">
				...
				<!-- Main -->
                    ...
                    <form  id="form" name="search" method="POST" action="users.php" width="50%">
<div class="row gtr-uniform"> 

    <div class="col-6 col-12-small">
        <input type="text" name="nume" placeholder="Introduceti numele utilizatorului">
    </div>
    <div class="col-6 col-12-small">
        <input type="submit" name="search" value="Cauta utilizatorul"/>
    </div>
    <div class="col-12" >
...
<tbody>
    ...
    ?>
        ...
        <td>
            <?php echo "<a href=\"edit_user.php?id=".$row['id']."\">Edit</a><br>
            <a href=\"delete_user.php?id=".$row['id']."\" onclick=\"return confirm('Are you sure?')\">Delete</a><br>"?>
        </td>
        </tr>
<?php
    }
    ...
    <a href="add_user.php" class="button large">Adaugati un user</a>
</div>
					</div>
