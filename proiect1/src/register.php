...
<body class="is-preload">
    ...
    <div id="wrapper">
        ...
        <div id="main" class="alt">
            <div id="form">
                <form name="userForm" method="post" action="save_user.php" enctype="multipart/form-data" onsubmit="return validateForm()">
                    <div class="row gtr-uniform">
                        ...
                        <div class="col-12" align="center">
                            <input type="submit" name="upload" value="Creaza cont">
                        </div>
                    </div>
                </form>
            </div>
